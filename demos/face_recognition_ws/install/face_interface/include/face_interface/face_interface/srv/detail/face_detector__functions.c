...
face_interface__srv__FaceDetector_Request__init(face_interface__srv__FaceDetector_Request * msg)
{
  ...
  if (!sensor_msgs__msg__Image__init(&msg->image)) {
    face_interface__srv__FaceDetector_Request__fini(msg);
    return false;
  }
  return true;
}
...
face_interface__srv__FaceDetector_Request__create()
{
  ...
  face_interface__srv__FaceDetector_Request * msg = (face_interface__srv__FaceDetector_Request *)allocator.allocate(sizeof(face_interface__srv__FaceDetector_Request), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(face_interface__srv__FaceDetector_Request));
  bool success = face_interface__srv__FaceDetector_Request__init(msg);
  if (!success) {
...
face_interface__srv__FaceDetector_Request__Sequence__init(face_interface__srv__FaceDetector_Request__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  face_interface__srv__FaceDetector_Request * data = NULL;

  if (size) {
    data = (face_interface__srv__FaceDetector_Request *)allocator.zero_allocate(size, sizeof(face_interface__srv__FaceDetector_Request), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = face_interface__srv__FaceDetector_Request__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        face_interface__srv__FaceDetector_Request__fini(&data[i - 1]);
      }
...
face_interface__srv__FaceDetector_Request__Sequence__fini(face_interface__srv__FaceDetector_Request__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      face_interface__srv__FaceDetector_Request__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  face_interface__srv__FaceDetector_Request__Sequence * array = (face_interface__srv__FaceDetector_Request__Sequence *)allocator.allocate(sizeof(face_interface__srv__FaceDetector_Request__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = face_interface__srv__FaceDetector_Request__Sequence__init(array, size);
  if (!success) {
...
face_interface__srv__FaceDetector_Request__Sequence__destroy(face_interface__srv__FaceDetector_Request__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    face_interface__srv__FaceDetector_Request__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
face_interface__srv__FaceDetector_Request__Sequence__are_equal(const face_interface__srv__FaceDetector_Request__Sequence * lhs, const face_interface__srv__FaceDetector_Request__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!face_interface__srv__FaceDetector_Request__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  face_interface__srv__FaceDetector_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(face_interface__srv__FaceDetector_Request);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    face_interface__srv__FaceDetector_Request * data =
      (face_interface__srv__FaceDetector_Request *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!face_interface__srv__FaceDetector_Request__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          face_interface__srv__FaceDetector_Request__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!face_interface__srv__FaceDetector_Request__copy(
...
face_interface__srv__FaceDetector_Response__init(face_interface__srv__FaceDetector_Response * msg)
{
  ...
  if (!rosidl_runtime_c__int32__Sequence__init(&msg->top, 0)) {
    face_interface__srv__FaceDetector_Response__fini(msg);
    return false;
  }
  // right
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  face_interface__srv__FaceDetector_Response * msg = (face_interface__srv__FaceDetector_Response *)allocator.allocate(sizeof(face_interface__srv__FaceDetector_Response), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(face_interface__srv__FaceDetector_Response));
  bool success = face_interface__srv__FaceDetector_Response__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
face_interface__srv__FaceDetector_Response__Sequence__init(face_interface__srv__FaceDetector_Response__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  face_interface__srv__FaceDetector_Response * data = NULL;

  if (size) {
    data = (face_interface__srv__FaceDetector_Response *)allocator.zero_allocate(size, sizeof(face_interface__srv__FaceDetector_Response), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = face_interface__srv__FaceDetector_Response__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        face_interface__srv__FaceDetector_Response__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
face_interface__srv__FaceDetector_Response__Sequence__fini(face_interface__srv__FaceDetector_Response__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      face_interface__srv__FaceDetector_Response__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  face_interface__srv__FaceDetector_Response__Sequence * array = (face_interface__srv__FaceDetector_Response__Sequence *)allocator.allocate(sizeof(face_interface__srv__FaceDetector_Response__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = face_interface__srv__FaceDetector_Response__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
face_interface__srv__FaceDetector_Response__Sequence__destroy(face_interface__srv__FaceDetector_Response__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    face_interface__srv__FaceDetector_Response__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
face_interface__srv__FaceDetector_Response__Sequence__are_equal(const face_interface__srv__FaceDetector_Response__Sequence * lhs, const face_interface__srv__FaceDetector_Response__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!face_interface__srv__FaceDetector_Response__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  face_interface__srv__FaceDetector_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(face_interface__srv__FaceDetector_Response);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    face_interface__srv__FaceDetector_Response * data =
      (face_interface__srv__FaceDetector_Response *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!face_interface__srv__FaceDetector_Response__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          face_interface__srv__FaceDetector_Response__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!face_interface__srv__FaceDetector_Response__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
